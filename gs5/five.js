...
lib.ssMetadata = [
		{name:"five_atlas_1", frames: [[0,0,1024,812],[0,814,450,340]]}
];
...
(lib.Behind = function() {
	this.initialize(ss["five_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#92B0CF").s().p("EhK/AvfMAAAhe9MCV/AAAMAAABe9g");
	this.shape.setTransform(493,957.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Scratchable, new cjs.Rectangle(13,653.6,960,607.8000000000001), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-88,-77,0.4297,0.4174);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Cursor_1, new cjs.Rectangle(-88,-77,193.4,141.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-108,16,0.8941,0.7997);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Behind_1, new cjs.Rectangle(-108,16,915.6,649.4), null);
...
}).prototype = getMCSymbolPrototype(lib._2, new cjs.Rectangle(-160,-133,193.4,141.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(625.95,200.85,1.247,0.8438,0,0,0,401.4,266.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._1, new cjs.Rectangle(-9.2,-10.8,1141.6000000000001,547.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.scratchable.setTransform(-13,-652.55,1,0.9807,0,0,0,0,-0.1);
	...
	this.instance_5.setTransform(0,0,0.8525,1.0305);
	this.instance_5.cache(-11,-13,1146,552);
...
p.nominalBounds = new cjs.Rectangle(472.1,258.5,493.29999999999995,326.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/five_atlas_1.png?1659368676391", id:"five_atlas_1"}
	],
	preloads: []
};
